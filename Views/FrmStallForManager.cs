...
{
    public partial class FrmStallForManager : Form, IStallViewForManager
    {
        private StallPresenterForManager _presenterForManager;
        ...
        public FrmStallForManager(StallRepository stallRepository, AuthenticationService authService)
        {
            InitializeComponent();
            AssociateAndRaiseViewEvents();

            _authService = authService;
            _presenterForManager = new StallPresenterForManager(this, stallRepository);
