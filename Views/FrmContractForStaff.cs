...
{
    public partial class FrmContractForStaff : Form, IContractViewForStaff
    {
        private readonly ToolTip _toolTip = new ToolTip();
        private readonly AuthenticationService _authService;

        public FrmContractForStaff(AuthenticationService authService)
        {
            InitializeComponent();
            ...
            MaximizeBox = false;
            MinimizeBox = true;
            var contractPresenter = new ContractPresenterForStaff(this, new ContractRepository());
